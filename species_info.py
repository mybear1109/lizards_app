...
def get_species_info(species_name):
    ...
    "8.비어디 드래곤(Beardy)": {
        "설명": "비어디 드래곤은 온순한 성격을 가진 도마뱀으로, 호주의 사막 지역에서 서식합니다. 특징적인 턱 아래 수염 모양의 비늘을 가지고 있으며, 체온 조절을 위해 수염을 펼치기도 합니다. 몸길이는 보통 30cm~60cm 정도이며, 수명은 적절한 관리 시 8~10년 이상 생존할 수 있습니다. 비어디 드래곤은 매우 호기심이 강하고 지능이 뛰어나며, 주인과의 교감을 즐기는 특성이 있습니다.",
        "서식지": "호주의 건조지대, 사바나, 사막 지역이 주 서식지입니다. 자연 환경에서는 바위나 나무 등의 돌출물 위에서 생활합니다. 사육 시에는 사막과 비슷한 환경을 조성해야 하며, 온도와 습도 조절이 중요합니다. 적절한 태양광 또는 UVB 조명을 제공해야 합니다.",
        "먹이": "비어디 드래곤은 잡식성으로, 다양한 먹이를 섭취합니다. 주로 곤충류(귀뚜라미, 밀웜, 메뚜기 등)를 먹으며, 채소와 과일도 일부 섭취합니다. 성장 단계에 따라 먹이의 비율을 조절해야 하며, 어릴 때는 단백질 위주로, 성체가 되면 채소의 비중을 늘려야 합니다.",
        "특징": "1.온순한 성격과 높은 지능\n2.체온 조절을 위한 수염 퍼짐\n3.색상 변화 능력 (감정 표현, 체온 조절)\n4.강한 호기심과 사회성\n5.손에 익숙해져 핸들링이 쉬움\n6.수컷의 번식기 특유의 행동 (꼬리 흔들기)\n7.자외선을 이용한 비타민 D 합성 능력\n8.건조한 환경 적응력\n9.수직 표면 등반 능력\n10.주기적인 허물 벗기",
        "이미지": "images/0 Beardy Dragon.jpg"
    },
    "9.앨리케이터(Alligator)": {
        "설명": "앨리게이터는 대형 파충류로, 강한 턱과 단단한 비늘로 덮인 몸을 가지고 있습니다. 주로 북미와 중국에서 서식하며, 평균 몸길이는 3~4미터에 이릅니다. 앨리게이터는 넓고 둥근 U자 모양의 주둥이를 가지고 있어 크로커다일과 구별됩니다. 수명은 30~50년 정도이며, 수중 생활에 잘 적응한 강력한 포식자입니다.",
        "서식지": "앨리게이터는 주로 습지, 강, 늪에서 서식합니다. 미국 남동부의 루이지애나, 플로리다, 조지아, 앨라배마, 미시시피, 노스캐롤라이나, 사우스캐롤라이나, 텍사스 등에 널리 분포합니다. 최근에는 테네시주와 같이 더 북쪽으로 서식지를 확장하고 있습니다.",
        "먹이": "앨리게이터는 기회주의적 포식자로, 다양한 먹이를 섭취합니다. 주로 물고기, 포유류, 조류를 사냥하지만, 크기에 따라 먹이의 종류가 달라집니다. 어린 개체는 주로 작은 물고기와 곤충을 먹고, 성체는 더 큰 동물들을 사냥합니다. 매복 공격 전략을 사용하여 먹이를 잡아 물에 끌어들인 후 익사시키거나 통째로 삼킵니다.",
        "특징": "1.강한 턱과 날카로운 이빨\n2.수중 생활에 적응된 신체 구조\n3.U자형 넓은 주둥이 (크로커다일과의 차이점)\n4.뛰어난 수영 능력\n5.체온 조절을 위한 일광욕 습성\n6.야행성 및 매복 사냥 전략\n7.긴 수명 (30~50년)\n8.모성 행동 (둥지 보호 및 새끼 돌봄)\n9.계절에 따른 활동 변화 (겨울철 활동 감소)\n10.생태계에서 최상위 포식자로서의 역할",
        "이미지": "images/alligator.jpg"
    },
    "10.이구아나(Iguana)": {
        "설명": "이구아나는 크기가 크며 초식성이 강한 도마뱀으로, 강한 햇빛을 좋아합니다. 등에 가시 돌기가 있으며 수영 능력이 있습니다. 푸른이구아나의 경우 오직 그랜드캐이먼 섬에서만 발견되며, 인간의 정착과 개발로 인해 서식지가 줄어들고 있습니다.",
        "서식지": "중남미 열대우림, 건생식물이 자라는 수풀, 경작지, 도로 주변, 정원, 높은 숲 등에서 서식합니다. 일부 종은 해안가 근처에서도 발견됩니다. 바위가 많고 햇볕이 강하게 비치는 마른 숲이나 해안가를 선호합니다.",
        "먹이": "주로 초식성으로, 잎, 꽃, 과일을 먹습니다. 야생에서는 때때로 경작지나 과수원에서 먹이를 찾기도 합니다. 어린 개체는 일부 곤충류도 섭취할 수 있습니다.",
        "특징": "1.등에 가시 돌기 존재\n2.뛰어난 수영 능력\n3.강한 햇빛 선호\n4.나무 위 생활 적응\n5.긴 꼬리로 균형 유지 및 방어\n6.체온 조절을 위한 일광욕 습성\n7.암컷의 산란을 위한 해안가 이동\n8.성장에 따른 서식 환경 변화 (어린 개체는 나무 선호)\n9.천적이 거의 없는 성체 (외래종 제외)\n10.3-4년의 성적 성숙 기간",
        "이미지": "images/4 Iguana.jpg"
    },
    "11.카멜레온(Chameleon)": {
        "설명": "카멜레온은 색을 변화시키고 긴 혀를 이용해 먹이를 잡는 능력을 가진 특별한 도마뱀입니다. 독립적인 눈 움직임을 가지고 있으며, 크기는 종에 따라 2.5cm에서 68cm까지 다양합니다. 수명은 종에 따라 다르지만 일반적으로 3~10년 정도입니다. 카멜레온은 주로 나무 위에서 생활하며, 특유의 발 구조로 가지를 잡고 이동합니다.",
        "서식지": "카멜레온은 주로 아프리카와 마다가스카르에 서식하며, 일부 종은 남부 유럽, 중동, 남아시아, 스리랑카에도 분포합니다. 열대우림, 사바나, 사막, 산림 등 다양한 환경에 적응했습니다. 대부분의 종은 나무 위에서 생활하지만, 일부는 관목이나 지면에서 서식합니다.",
        "먹이": "카멜레온은 주로 곤충을 먹습니다. 긴 혀를 이용해 빠른 속도로 먹이를 잡아챕니다. 주요 먹이로는 귀뚜라미, 메뚜기, 나방, 파리 등이 있으며, 큰 종의 경우 작은 조류나 도마뱀도 잡아먹을 수 있습니다. 일부 종은 식물의 잎이나 과일도 섭취합니다.",
    ...
    "12.크레스티드 게코(Crestedgeko)": {
        "설명": "크레스티드 게코는 나무 위에서 생활하며 점착성 패드를 이용해 벽을 기어오를 수 있습니다. 볏 모양의 돌기가 특징입니다. 중앙아메리카의 남동부에 서식하는 작은 파충류로, 특이한 외모와 성격으로 애완동물로서 인기를 얻고 있습니다.",
        "서식지": "주로 열대 우림 지역에서 발견되며, 나무와 식물의 잎사귀에 서식합니다. 뉴칼레도니아의 열대우림이 원산지이지만, 현재는 애완동물로 전 세계에서 사육되고 있습니다.",
        "먹이": "과일과 곤충을 주로 먹습니다. 야생에서는 작은 곤충들과 과일의 즙을 섭취하며, 사육 시에는 특별히 제조된 파우더 사료와 생과일, 작은 곤충을 급여합니다.",
        "특징": "1.볏 모양의 특징적인 돌기\n2.점착성 패드를 가진 발로 수직 표면 등반 가능\n3.꼬리 자할(탈락) 능력\n4.야행성 습성\n5.온순한 성격으로 핸들링이 쉬움\n6.습도에 민감한 피부\n7.눈을 핥아 청소하는 독특한 습관\n8.색상 변화 능력 (제한적)\n9.소리를 내어 의사소통\n10.긴 수명 (적절한 관리 시 15-20년)",
        "이미지": "images/2 Crestedgeko.jpg"
    },
    "13.크로커다일(Crocodile)": {
